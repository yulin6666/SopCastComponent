...
public class Predictor {
    ...
    protected boolean loadModel(Context appCtx, String modelPath, int cpuThreadNum, String cpuPowerMode) {
        ...
        config.detModelFilename = realPath + File.separator + "ch_ppocr_mobile_v1.1_det_opt.nb";
        config.recModelFilename = realPath + File.separator + "ch_ppocr_mobile_v1.1_rec_opt.nb";
